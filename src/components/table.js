...
export default (props) =>{
  ...
  'BSG':BSG, 'CC':CC, 'CTR':CTR, 'DRA':DRA, 'OBG':OBG, 'TS':TS, 'UNL':UNL, 'VS':VS,
  ...
  'ASE':ASE,'CES':CES,'GAM':GAM,'GE':GE,'SE':SE,'SGB':SGB,'TSE':TSE,'TW':TW,
    ...
    return (
        <div style={{width:'fit-content', marginLeft:'2%', marginTop:'0%',}}>
  ...
  <tbody>
    {props.ratings['teams'].map((item, index)=>{
      return (<tr>
      <td className='rank' scope="row" style={{backgroundColor:props.ratings['teams'][index].color}}>{index+1}</td>
      <td><img src={icons[props.ratings['teams'][index].flag]}></img>{props.ratings['teams'][index].name}</td>
      <td className='rank' scope="row" style={{color:'white'}}><span style={{color:'#00FA9A'}}>{props.ratings['teams'][index].score[0]}</span>/<span style={{color:'#DC143C'}}>{props.ratings['teams'][index].score[1]-props.ratings['teams'][index].score[0]}</span></td>
      <td>{props.ratings['teams'][index].rating}</td>
      <td className='correction'  style={{color:props.ratings['teams'][index].cc}}>{props.ratings['teams'][index].correction}</td>
      <td>&#177;{props.ratings['teams'][index].deviation}</td>
    </tr>)
    })//#00FA9A", "color": "#A020F0"
