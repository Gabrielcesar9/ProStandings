     ...
     <Routes>
      ...
      <footer style={{margin:'auto', marginTop:'3%', padding:'1%', width:'90%', borderTop:'solid white 1px'}}>
        ...
        <div style={{display:'flex', width:'30%', margin:'auto'}}>
          ...
          <div style={{color:'white', fontSize:'10px', width:'60%', textAlign:'center', margin:'auto', marginTop:'1%'}}>ProStandings isn't endorsed by Riot Games and doesn't reflect the views or opinions of Riot Games or anyone officially involved in producing or managing Riot Games properties. Riot Games, and all associated properties are trademarks or registered trademarks of Riot Games, Inc.</div>
      </footer>
